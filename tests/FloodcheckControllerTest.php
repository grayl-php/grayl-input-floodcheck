<?php
    ...
    */
   class FloodcheckControllerTest extends TestCase
   {
       ...
       * @throws \Exception
       */
      public function testFloodcheckControllerSuccess ( FloodcheckController $floodcheck ): FloodcheckController
      {
       ...
       * @throws \Exception
       */
      public function testFloodcheckControllerFailure ( FloodcheckController $floodcheck ): void
      {
