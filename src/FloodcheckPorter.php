...
class FloodcheckPorter
{
     ...
     * @throws \Exception
     */
    public function newFloodcheckController(
        string $tag,
        int $max_attempts,
        string $floodcheck_log_ttl
    ): FloodcheckController {

        // Create a new FloodcheckLog
        $floodcheck_log = new FloodcheckLog(
        ...
        return new FloodcheckController(
            $floodcheck_log,
            $floodcheck_log_ttl_interval,
            $max_attempts,
            new FloodcheckService(),
            new FloodcheckDatabaseMapper(
                'input_floodcheck',
